...
import { SITE_EMAIL, SITE_ROLE } from "@/lib/site-metadata";
...
function EmphasizedDescription({ text, terms }: { text: string; terms: string[] }) {
          ...
          <p className="hero-description text-pretty text-[1.375rem] leading-[1.12] tracking-[-0.02em] text-design-light-text-primary sm:pr-36 sm:text-[clamp(2rem,2.65vw,2.5rem)] sm:leading-[1.1]">
            {reducedMotion ? (
              ...
              <DecryptedText
                ...
                speed={30}
                animateOn="view"
                emphasizedTerms={hero.emphasizedTerms}
